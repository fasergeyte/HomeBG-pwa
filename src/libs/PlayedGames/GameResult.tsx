...
export function GameResult(props: { control: Control<FormValues>; }) {
  const { control } = props;
          ...
          <Controller
            ...
            render={({ field: { onChange, ...props } }) => (
              <Autocomplete
                ...
                getOptionLabel={(val) => typeof val === "string" ? val : val.name}
                renderInput={(params) => (
                  <TextField
                    {...params}
                    size="small"
                    ...
                    sx={{
                      "& .MuiInputBase-root": {
                        ...
                        borderBottomRightRadius: fields.length - 1 === index ? 4 : 0,
